/**
 * DispenseControl Test App (5V stepper motor)
 *
...
{
    ESP_LOGI(TAG, "DispenseControl Test App (5V stepper motor)");
    ...
    DispenseControl::Config config = {
        .default_portions = 1,
        .steps_per_portion = 512,  // 1/8 rev of 28BYJ-48 (4096 half-steps/rev)
        .motor_rpm = 10,
