...
{
	eGAIN_128 = 1,// channel A
	eGAIN_64 = 3, // channel A
	eGAIN_32 = 2 // channel B
}HX711_GAIN;
...
// Dual-channel calibration function
// known_weight: Known weight (grams)
// tare_delay_ms: Waiting time after peeling (milliseconds)
// weight_delay_ms: Waiting time (milliseconds) after placing a known weight
